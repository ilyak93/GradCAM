...
def main():
    ...
    batch_size = 1
    train_loader = DataLoader(train_ds, batch_size, shuffle=False, num_workers=0, pin_memory=True)
    orig_train_loader = DataLoader(orig_train_ds, batch_size, shuffle=False, num_workers=0, pin_memory=True)
